    ...
    for RECORD in all_records:
        for alignment in RECORD.alignments:
            for hsp in alignment.hsps:
                ...
                PARAM_UNIProtID_FromXML.add(tmp[0])
                PARAM_UNIProtID = PARAM_UNIProtID_FromXML # | PARAM_UNIProtID_FromGI | PARAM_UNIProtID_FromACC 
                ...
                L.append (alignment.hit_id);#<Hit_def>PREDICTED: protein dpy-30 homolog [Xiphophorus maculatus]</Hit_def>                
...
def argument_parser():
    parser = argparse.ArgumentParser(description="process XML output from BLAST")
    parser.add_argument("-i", "--in_folder", type=str, default="/home/sukaew/CAFA_QA/targetFiles/blastp45/", help="full path to input file -- xml.gz file from Blast run")
    parser.add_argument("-o", "--out_folder", type=str, default="/home/sukaew/CAFA_QA/targetFiles/blastp45_features/", help="full path to out folder file from Blast run")
