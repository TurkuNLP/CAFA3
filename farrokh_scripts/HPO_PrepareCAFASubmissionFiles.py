...
#
#-i /home/farmeh/Desktop/PROJECTS/GIT/CAFA3/data/testpred/HPO_test-allfolds-predicted.tsv.gz -o /home/farmeh/Desktop/PROJECTS/GIT/CAFA3/data/testpred/ExampleSubmissionFolder/ -m 1 -l /home/farmeh/Desktop/PROJECTS/GIT/CAFA3/data/testpred/ExampleSubmissionFolder/

TARGET_ORGANISMS = ["hpo"] 
...
if __name__== "__main__": 
    ...
    ErrLogFileAddress = args.logDir + "MODEL" + args.modelNumber + "_" + DATETIME_GetNowStr() + "_HPO.log" 
    ...
    for row in csv_reader:
        ...
        if (Internal_cafa_ids == None):
            Errlog ("NO CAFA_ID: " + str(row))
            continue 
